...
OWNER_ID = environ.get('OWNER_ID', '5071463525')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002206282617').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5071463525').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://win3298:QgcZpBkFdb14jKY7@cluster0.jdyos0q.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001580437794')) #Log channel id ( make sure bot is admin )
